...
[![Build Status](https://smart-stock-ai.visualstudio.com/Kick-Start/_apis/build/status%2Fcuicaihao.python-sample-vscode-flask-tutorial?branchName=main)](https://smart-stock-ai.visualstudio.com/Kick-Start/_build/latest?definitionId=1&branchName=main)
...
* To run the app locally:
  ...
  2. Run the command `set FLASK_APP=webapp` (Windows cmd) or `export FLASK_APP=webapp` (macOS/Linux) to point to the app module.
